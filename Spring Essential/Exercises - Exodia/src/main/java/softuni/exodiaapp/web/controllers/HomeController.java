...
import softuni.exodiaapp.web.domain.models.view.DocumentHomeViewModel;
...
public class HomeController {
    ...
    public ModelAndView home(ModelAndView modelAndView, HttpSession session) {
        if (session.getAttribute("username") == null) {
            ...
            List<DocumentHomeViewModel> documents = this.documentService.findAllDocumnts().stream().map(d -> this.modelMapper.map(d, DocumentHomeViewModel.class)).map(doc -> {
